...
def createModelObject(name):
    ...
    file.write('use backint\\core\\QueryBuilder\\QueryBuilder;\n')
    ...
    file.write('\t\telse\n')
    file.write('\t\t{\n')
    file.write('\t\t\tHttp::sendResponse(NO_CONTENT, Http::messageToJSON("Resource does not exist"));\n')
    file.write('\t\t}\n')
    file.write('\t}\n\n')
    file.write('\tpublic function create($params, $requestBody) {\n')
    file.write('\t\t$this->oi' + name.capitalize() + ' = Http::fillObjectFromJSON($this->oi' + name.capitalize() + ', $requestBody);\n')
    file.write('\t\t$err = OController::insert($this->oi' + name.capitalize() + ');\n')
    file.write('\t\tif($err->hasErrors())\n')
    file.write('\t\t\t$err->sendError();\n')
    file.write('\t\telse\n')
    file.write('\t\t\tHttp::sendResponse(CREATED, Http::messageToJSON("Created correctly"));\n')
    file.write('\t}\n\n')
    ...
    file.write('\t\t\t$err->sendError();\n')
    file.write('\t\telse\n')
    file.write('\t\t\tHttp::sendResponse(CREATED, Http::messageToJSON("Updated correctly"));\n')
    file.write('\t}\n\n')
    ...
    file.write('\t\t\t$err->sendError();\n')
    file.write('\t\telse\n')
    file.write('\t\t\tHttp::sendResponse(CREATED, Http::messageToJSON("Deleted correctly"));\n')
    file.write('\t}\n')
    file.write('}\n')
    file.write('?>')
    file.close()
